...
{# sets the path to modulefiles outside of spack's control used by this modulefile #}
set plat [exec /home/gfdl/bin2/gfdl_platform]
switch ${plat} {
	hpcs-csc {
		module load globus
		module load slurm
	...
	desktop {
		puts stderr "Warning: Fre-Bronx cannot run batch jobs on the workstation. You will be working with limited functionality."
	}
}	
...
set mylog [exec perl /usr/local/Modules/modulefiles/.frelog "[module-info mode]" "[module-info name]" spack-2025.02]
{% endblock %}
