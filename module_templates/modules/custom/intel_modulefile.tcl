...
{% block compiler_modules %}
{# sets the path to modulefiles complied by the specific compiler #}
{# note that the below path is only going to work for production settings #}
module use /app/spack/2025.02/modulefiles-oneapi-2025.2.0/linux-rhel8-x86_64_v2
{% endblock %}
